...
from SerenaRobot import OWNER_ID, pbot, arq
from SerenaRobot.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from SerenaRobot.utils.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/903fcefc3f4086ad592fa.png",
...
async def alive_function(answers):
    ...
    msg = f"""
**[Serena 💖](https://github.com/AASFCYBERKING/SerenaRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**Profiles:** [BOT](t.me/SerenaYvonneRobot) | [UBOT](t.me/SerenaXhelper)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/d2ce86cb1c1dfed4cd12d.png",
