...
import SerenaRobot.modules.sql.notes_sql as sql
from SerenaRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from SerenaRobot.__main__ import DATA_IMPORT
from SerenaRobot.modules.helper_funcs.chat_status import user_admin
from SerenaRobot.modules.helper_funcs.alternate import typing_action

# from SerenaRobot.modules.rules import get_rules
import SerenaRobot.modules.sql.rules_sql as rulessql

# from SerenaRobot.modules.sql import warns_sql as warnssql
import SerenaRobot.modules.sql.blacklist_sql as blacklistsql
from SerenaRobot.modules.sql import disable_sql as disabledsql

# from SerenaRobot.modules.sql import cust_filters_sql as filtersql
# import SerenaRobot.modules.sql.welcome_sql as welcsql
import SerenaRobot.modules.sql.locks_sql as locksql
from SerenaRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("SerenaRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SerenaRobot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Serena-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("SerenaRobot{}.backup".format(chat_id))  # Cleaning file
