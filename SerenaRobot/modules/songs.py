...
from SerenaRobot import pbot as Turbo
from SerenaRobot.pyrogramee.dark import get_arg


@Turbo.on_message(filters.command("saavn"))
...
@serena.on_message(filters.command("deezer"))
